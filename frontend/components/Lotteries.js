...
const noLotteriesGif = "/no-lotteries.gif";
...
const Lotteries = ({
  ...
  const [lotteriesFilter, setLotteriesFilter] = useState(0);
    ...
    <>
      <div className={styles.dropdownContainer}>
        <div className={styles.dropdown}>
          <Dropdown
            label="Lotteries: "
            onChange={({ id }) => handleDropdownChange(id)}
            selectedState={lotteriesFilter}
            options={[
              {
                id: 0,
                label: "All",
      ...
      <div className={styles.lotteries}>
        {filterLotteries(lotteries, lotteriesFilter).length !== 0 ? (
          ...
          <div className={styles.noLotteries}>
            <h1>No lotteries here....</h1>
            <Image src={noLotteriesGif} width={300} height={300} />
            <Button
              text="Show all lotteries"
              type="button"
              theme="colored"
              color="yellow"
              onClick={() => setLotteriesFilter(0)}
            />
          </div>
        )}
      </div>
